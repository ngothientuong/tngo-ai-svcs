...
if __name__ == "__main__":
    ...
    endpoint = "https://XXXXXXXXXcontentsafety.cognitiveservices.azure.com/"
    ...
    # content = "Killings, shootings, and other violent acts can be allowed."
