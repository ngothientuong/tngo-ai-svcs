...
def image_url_to_base64(image_url):
    """
    Download an image from a URL and convert it to a base64-encoded string.

    :param image_url: URL of the image to be converted
...
if __name__ == "__main__":
    ...
    endpoint = "https://XXXXXXXXXXXXXcontentsafety.cognitiveservices.azure.com/"
    ...
    image_url = "https://images-prod.dazeddigital.com/900/azure/dazed-prod/1390/6/1396041.jpg"
    content = image_url_to_base64(image_url)
